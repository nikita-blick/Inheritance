...
#define SHAPE_GIVE_PARAMETERS start_x, strat_y, line_width, color                     
	...
	public:
		...
		void draw()const override
		{
			...
			// 2) Получим конкест устройства (Dc - Device Context) для окна консоли
			...
			// 5) После того, как все необходимые интсрументы созданы и выбраны, можно рисовать
			::Rectangle(hdc, start_x, start_y, start_x + width, start_y + height);
		
			// 6) hdc, hPen and hBrush занимают ресурсы, а ресурсы нужно освобождать
...
void main()
{
	...
	Geometry::Rectangle rect(150,100, 550, 100, 2, Geometry::Color::Blue);
	rect.info();
	while (true)
	{
		square.draw();
